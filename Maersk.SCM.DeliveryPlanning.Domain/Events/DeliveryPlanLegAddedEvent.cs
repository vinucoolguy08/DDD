...
{
    public class DeliveryPlanLegAddedEvent : IEvent
    {
        ...
        public DeliveryPlanLegAddedEvent(DeliveryPlan deliveryPlan, DeliveryPlanLeg deliveryPlanLeg, Guid deliveryPlanId) 
        {
