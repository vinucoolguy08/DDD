...
{
    public class DeliveryPlanLegUpdatedEvent : IEvent
    {
        ...
        public DeliveryPlanLegUpdatedEvent(DeliveryPlan deliveryPlan, DeliveryPlanLeg deliveryPlanLeg, Guid deliveryPlanId)
        {
